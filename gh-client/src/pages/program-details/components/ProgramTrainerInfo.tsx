...
export default function ProgramTrainerInfo() {
  return (
    <Card className="w-full max-w-screen-lg border-0">
      ...
      <CardContent>
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div>
              <p className="text-sm font-medium">anjam@mail.com</p>
            </div>
          </div>
        </div>
        <div className="mt-6">
          <h3 className="text-sm text-muted-foreground text-justify">
