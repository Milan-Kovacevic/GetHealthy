...
CREATE TABLE IF NOT EXISTS `get_healthy`.`TRAINEE_EXERCISING` (
  ...
  INDEX `fk_TRAINEE_EXERCISING_TRAINING_PROGRAM_ON_SCHEDULE1_idx` (`ProgramScheduleId` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_TRAINEE_EXERCISING_TRAINEE1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TRAINEE_EXERCISING_TRAINING_PROGRAM_ON_SCHEDULE1`
    FOREIGN KEY (`ProgramScheduleId`)
