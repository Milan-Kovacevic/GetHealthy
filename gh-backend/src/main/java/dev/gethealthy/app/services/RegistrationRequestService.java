...
public interface RegistrationRequestService {
    Page<RegistrationRequestResponse> getRequests(Pageable page);
    
    void processRequest(Integer id, ProcessRequest request);

    RegistrationRequestResponse getRequest(Integer id);
}
